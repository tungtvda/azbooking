...
{
    $url='<li><a href="'.SITE_NAME.'">Trang chủ</a></li><li><a href="'.SITE_NAME.'/cam-nang/">'.$data['menu'][3]->name.'</a></li><li><a href="'.SITE_NAME.'/cam-nang/'.$danhmuc_1[0]->name_url.'/">'.$danhmuc_1[0]->name.'</a></li><li><span>'.$data['detail'][0]->name.'</span></li>';
