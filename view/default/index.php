        ...
        if($count_noti>0){
            ...
            $asign['content_noti_user'].='
                        <li class="menu-item menu-item-has-children "><a href="#" style="padding: 0px 15px;   ">
                            ...
                            <ul class="sub-menu" style="text-align: left; width: 180px;">
                                <li class="menu-item"><a href="'.SITE_NAME.'/tiep-thi-lien-ket/ho-so/"><i class="fa fa-cogs "></i> Cài đặt tài khoản</a></li>
                                <li class="menu-item"><a href="'.SITE_NAME.'/tiep-thi-lien-ket/"><i class="fa fa-share-alt "></i> Tiếp thị liên kết </a>
                                </li>
