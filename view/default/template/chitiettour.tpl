        ...
        <div class="row">
            <div class="col-md-9">
                <div style="margin-top: 60px;" class="col-xs-12">
                    ...
                    <ul id="ul_tab_review" class="nav nav-tabs package-nav-tab" role="tablist" style=" ">
                            ...
                            <div class="initiative">
                                <div class="col-md-12 row">
                                    ...
                                    <ins><span class="parameter"> {code}</span></ins>
                                                ...
                                                <p class="price" style="margin-bottom: 10px"><i class="icon-plane"></i>
                                                    Phương tiện:
                                            ...
                                            <div itemprop="description">
                                                <div style="float: left;width: 100%;"
                                                     class="booking_detail_div grid grid_2">
                                                    <a href="{link_booking}{id_user}"
                                                       class="booking_detail btn btn-danger">ĐẶT
                                                        NGAY </a>
                                                    <div style="float: left;margin-top: 10px;margin-left: 10px;"
                                                        ...
                                                        <ul>
                                                            ...
                                                            <li>
                                                                <a href="https://twitter.com/intent/tweet?source=webclient&text={link}"
                                                                   target="_blank"><i style="background-color: #ffffff"
                                                            ...
                                                            <li>
                                                                <a href="http://pinterest.com/pin/create/button/?url={link}"
                                                            ...
                                                            <li>
                                                                <a href="mailto:?Subject={name}?&amp;body={name}:{content_short}"
                                                                   target="_blank"><i
