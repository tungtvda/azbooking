        ...
        <div class="row">
            <div class="col-md-3">
                <div class="widget widget_contact_info">
                    ...
                    <div class="logo"><img src="{SITE-NAME}/view/default/themes/images/logo-footer.png" alt=""></div>
                    <div class="widget_content"><p>25 California Avenue, Santa Monica, California. USA</p>
                        <p>+1-888-8765-1234</p><a href="#"><span class="__cf_email__"
                                                                 data-cfemail="ee8d81809a8f8d9aae8981888f9cc08d8183">[email&#160;protected]</span>
            ...
            <div class="col-md-2">
                <div class="widget widget_about_us"><h3>About Us</h3>
                    <div class="widget_content"><p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                            Vestibulum vel dignissim dolor. Ut risus orci, aliquam sit amet semper eget, egestas
                            aliquam felis.</p></div>
                </div>
            </div>
            <div class="col-md-2">
            ...
            <div class="col-md-3">
                <div class="widget widget_follow_us">
                    <div class="widget_content"><p>For Special booking request, please call</p><span class="phone">099-099-000</span>
                        <div class="awe-social"><a href="#"><i class="fa fa-twitter"></i></a> <a href="#"><i
                                        class="fa fa-pinterest"></i></a> <a href="#"><i class="fa fa-facebook"></i></a>
                            <a href="#"><i class="fa fa-youtube-play"></i></a></div>
                    </div>
                </div>
            </div>
        </div>
        <div class="copyright"><p>©2015 GOFAR travel™ All rights reserved.</p></div>
    </div>
</footer>
</div>
...
<!-- Mirrored from envato.megadrupal.com/html/gofar/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 10 Dec 2016 07:32:20 GMT -->
</html>