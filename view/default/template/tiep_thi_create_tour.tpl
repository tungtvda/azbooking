        ...
        <style>
            ...
            <div id="myModalCreateTour" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-6 col-md-6 item_form_create">
                                            <div class="form-group">
                                                ...
                                                <input rel="tooltip" data-original-title="" type="text" class="form-control valid-input" name="name_tour" id="input_name_tour" data-valid="required"  placeholder="Tên tour, điểm đến...">
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-12 item_form_create" style="margin-bottom: 0px">
                                            <div class="form-group">
                                                ...
                                                <div class="form-group label-floating ">
                                                    <textarea style="padding-bottom: 10px" rel="tooltip" data-original-title="" placeholder="Thông tin chi tiết chương trình tour, phương tiện, khách sạn, ghi chú khác..." class="form-control valid" rows="3" name="note_tour"
                                                              id="input_note_tour"></textarea>
                                                    <span class="material-input"></span></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div hidden class="row" id="show_note_confirm">
                                        <div class="col-xs-12 col-sm-12 col-md-12 item_form_create" style="margin-bottom: 0px">
                                            <div class="form-group">
                                                <label for="">Ghi chú xác nhận admin</label>
                                                <div class="form-group label-floating ">
                                                    <textarea rel="tooltip" data-original-title="" placeholder="" class="form-control valid" rows="2" name="note_confirm"
                                                              id="input_note_confirm"></textarea>
                                                    <span class="material-input"></span></div>
                                            </div>
                                        </div>
                                    </div>
