...
<div class="wrapper">
    ...
    <div class="sidebar" data-color="purple" data-image="{SITE-NAME}/view/default/themes/assets/img/sidebar-1.jpg">
        <div class="logo">
            <a href="{SITE-NAME}" class="simple-text">
        ...
        <div class="sidebar-wrapper">
            <ul class="nav">
                ...
                <li class="{trangchu_mn}">
                    <a href="{SITE-NAME}/tiep-thi-lien-ket/">
