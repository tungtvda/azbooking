...
<div id="Wrapper">
    ...
    <header id="Header">
        ...
        <div id="top_bar">
            <p class="mob_phone">
                <i class="fa fa-envelope"></i><a href="mailto:info@azbooking.vn">info@azbooking.vn</a>
            </p>
            <p class="mob_mail">
                <i class="fa fa-phone"></i><a href="tel:0943 838 222">0943 838 222</a>
            </p>
        </div>
    ...
    <div id="Content">
        <div class="content_wrapper clearfix">
            ...
            <div class="sections_group">
                ...
                <!-- Features -->
                <div class="section " style="padding:40px 0 20px; background-color:#fff">
                    <div class="section_wrapper clearfix">
                        <div class="items_group clearfix">
...
<script type='text/javascript' src='{SITE-NAME}/view/default/themes/js/js_index/jquery/ui/core.min.js'></script>
<script type='text/javascript' src='{SITE-NAME}/view/default/themes/js/js_index/jquery/ui/widget.min.js'></script>
<script type='text/javascript' src='{SITE-NAME}/view/default/themes/js/js_index/jquery/ui/mouse.min.js'></script>
...
<script>
    jQuery(document).ready(function ($) {
        ...
        $('#configurator .select-layout a').click(function (e) {
            ...
            if (newClass == 'layout-boxed') {
                $('html').css('background-color', '#2F313A');
            }
        });
        ...
        $('#configurator .select-header a').click(function (e) {
            ...
            var newClass = $(this).attr('class');
            $('body')
                    .removeClass('header-mt header-mb header-mr header-mo')
                    .addClass(newClass);
            $(this)
                    .parent().addClass('active')
                    .siblings().removeClass('active');
        ...
        $('#configurator .select-image a').click(function (e) {
            ...
            var image_attr = $(this).attr('data-rel');

            if (image) {
                image = 'url("images/configurator/bg/' + image + '") ' + image_attr;
            }

            $('html').css('background', 'none').css('background', image);
...
<!-- Mirrored from astritbublaku.com/demos/falco/falco/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 04 Sep 2017 01:28:08 GMT -->
</html>