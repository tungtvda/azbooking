...
////
$data['tour_PROMOTIONS']=tour_getByTop(5,'promotion=1 and status=1','id desc');
$data['tour_sales']=tour_getByTop(5,'price_sales!="" and status=1','id desc');
$data['tintuc_index']=news_getByTop(5,'','id desc');
$date_now=_returnGetDateTime();
$data['tour_count_down']=tour_getByTop(3,'count_down!="" and status=1 and count_down>"'.$date_now.'"','id desc');
