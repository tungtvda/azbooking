    ...
    <section class="header-site header-sticky header-overlay header-left layers-parallax layers-logo- invert">
        <div class="container header-block">
            <div class="logo">
                ...
                <a href="http://azbooking.vn" class="custom-logo-link" rel="home"
            ...
            <nav class="nav nav-horizontal">
                ...
                <ul id="menu-primary-menu-1" class="menu">
                    ...
                    <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-43"><a
                            href="#camket">Cam kết</a></li>
                    <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-44"><a href="#qa">Q&A</a>
                    </li>
                    <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-45"><a href="#reviews">Đánh giá</a>
                    </li>
                    <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-46"><a href="#support">Liên hệ</a>
                    </li>
                </ul>
